...
<table border="1" width="100%" cellspacing="0" cellpadding="0" style="font-family:;font-size:10px;">
	...
	<tr>
		<td style="text-align: center; padding:2px;height: 75px;">
			...
			?>
		<b><?php echo $jnsta.'<br />'.strtoupper(($row->kepemilikan)).'<br />'.$row->jenis_spta;?> </b>
			<br/>
			<? if($row->terbakar_sel == 1){
					echo '<span style="background-color: white;color: black; padding: 10px"><b>TERBAKAR</b></span>';
				}
			?>
            </td>
				...
				<tr>
					<td style="width: 50%; text-align: center;" width="50%" valign="top">
						...
						<table border="1" width="90%" cellspacing="0" cellpadding="0">
							...
							<tbody>
							<tr>
								<td style="padding:2px;width:20%">Hektar Tertebang</td><td><b><? echo $row->ha_tertebang;?></b></td>
							</tr>
							<tr>
								<td style="padding:2px;width:20%">Tgl Tebang</td><td><b><? echo $row->tgl_tebang;?></b></td>
							</tr>
							<tr>
								<td style="padding:2px;width:20%">No Truk / Sopir<br />&nbsp;<br/></td><td><? echo $row->no_angkutan . "-" . $row->ptgs_angkutan; ?></td>
							</tr>
							...
							?>
							<tr>
								<td style="padding:2px;width:30%">No. HV</td><td><? echo $row->no_hv;?></td>
							</tr>
							<tr>
								<td style="padding:2px;width:30%">Op. HV</td><td><? echo $row->op_hv;?></td>
							</tr>
							<?php
								}
							?>
							...
							?>
							<tr>
								<td style="padding:2px;width:30%">No. ST / No. CT</td><td><? echo $row->no_stipping;?></td>
							</tr>
							<tr>
								<td style="padding:2px;width:30%">Op. ST / Op. CT</td><td><? echo $row->op_stipping;?></td>
							</tr>
							<tr>
								<td style="padding:2px;width:30%">No. GL</td><td><? echo $row->no_gl;?></td>
							</tr>
							<tr>
								<td style="padding:2px;width:30%">Op. GL</td><td><? echo $row->op_gl;?></td>
							</tr>
							<?php
								}
							?>
