...
<!-- onkeyup="tonpol('pol_dlm_hasil_taksasi_ton_sd','pol_dlm_hasil_taksasi_persenpol_sd','pol_taksasi_ton_sd','ton_taksasi_tebu_sd')" -->
                            ...
                            <center><p id="txtcek" style="font-size: 13px;background-color: green;color: white"><b>RENDEMEN TIDAK SAMA CEK KEMBALI NERACA POL</b> atau klik <a href="javascript:cekdatainputan()" class="btn btn-primary">Cek data</a></p></center>
