<section class="content-header">
		...
		<li><a href="<?php echo site_url('tdetailkuotakkw') ?>"><?php echo $pageTitle ?></a></li>
 ...
 <section class="content">
		...
		<?php echo $this->session->flashdata('message');?>
		 ...
		 <form action="<?php echo site_url('tdetailkuotakkw/save/'.$row['id_field']); ?>" class='form-horizontal' 
...
<div class="col-md-12">
 		...
 		<div class="toolbar-line text-center">		
			...
			<a href="<?php echo site_url('tdetailkuotakkw');?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a>
 		</div>
