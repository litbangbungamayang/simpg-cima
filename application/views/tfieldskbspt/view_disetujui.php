    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <ul class="nav nav-tabs" style="margin:10px 0;background:#dedede">
                ...
                <li class="active"><a href="<?php echo site_url('tfieldskbspt/sptadisetujui/'.$row['id_field_skb']);?>"><i class="fa fa-check-square"></i> SPTA SESUAI SKB </a></li>
            </ul>
            <div class="box box-danger">
                <div class="box-header with-border">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        table = $('#gridv').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('listskbspt/gridssesuai')?>",
                "type": "POST"
            },
