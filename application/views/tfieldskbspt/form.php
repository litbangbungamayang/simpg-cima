        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    ...
                    <form action="<?php echo site_url('tfieldskbspt/save/'.$row['id_field_skb']); ?>" class='form-horizontal'
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group  " >
                                ...
                                <div class="col-md-8">
                                    <input type='text' onkeyup="getKodeBlok(event, this.value)" class='form-control input-sm' placeholder='' value='<?php echo $row['kode_blok'];?>' name='kode_blok' id="kode_blok"  /> <br />
                                    <i> <small></small></i>
                                </div>
                            </div>
                            <div class="form-group  " >
                                ...
                                <div class="col-md-8">
                                    <input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['harga_per_kg'];?>' name='harga_per_kg' id="harga_per_kg"   /> <br />
                                    <i> <small></small></i>
                                </div>
                            </div>
                            <div class="form-group  " >
                                ...
                                <div class="col-md-8">
                                    <input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['keterangan'];?>' name='keterangan' id="keterangan"   /> <br />
                                    <i> <small></small></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="toolbar-line text-center">
                            ...
                            <a href="<?php echo site_url('tfieldskbspt');?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a>
                        </div>
