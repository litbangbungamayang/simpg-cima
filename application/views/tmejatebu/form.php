 	...
 	<div class="row">
    	<div class="col-xs-12">
        	<span style="font-size:20px;padding-bottom:10px;">
            	<b><center style="padding:10px;background:red" id="">TOTAL INPUT GILING JAM INI</center></b>
          	</span>
        	<span style="font-size:46px;padding-bottom:2px;color:white">
            	<b><center style="padding:2px;background:red" id="total_jam"></center></b>
          	</span>
        	<span style="font-size:20px;padding-bottom:10px;">
            	<b><center style="padding:10px;background:red" id="">TOTAL INPUT SPTA GILING H.I.</center></b>
          	</span>
        	<span style="font-size:46px;padding-bottom:2px;color:white">
            	<b><center style="padding:2px;background:red" id="total_giling"></center></b>
          	</span>
 		</div>
	</div>
 </section>
...
$(document).ready(function() {
		...
		{  selected_value : '' });
	$.ajax({
    	url: "api_bcn/getTebuGilingSekarang",
    	dataType: "json",
    	type: "GET",
    }).done(function(data){
    	if (data[0].total_tebu == null){
        	$("#total_giling").html(0);
        } else {
    		$("#total_giling").html(data[0].total_tebu);
        }
    });
	$.ajax({
    	url: "api_bcn/getTebuGilingJamIni",
    	dataType: "json",
    	type: "GET",
    }).done(function(data){
    	if (data[0].total_tebu == null){
    		...
    		$("#total_jam").html(data[0].total_tebu);
        }
    });
});
